                ...
                <form id="equipmentDataForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="equipment_description" required>
                        </div>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        ...
                        <p><strong>Equipment ID:</strong> <span id="detailEquipmentId"></span></p>
            ...
            function createEquipment(equipmentData) {
                ...
                fetch('/api/additional-equipment', {
                        ...
                        body: JSON.stringify({
                            ...
                            equipment_description: equipmentData.equipment_description
                        })
                    })
                    .then(response => {
                        if (!response.ok) {
            ...
            function viewEquipment(id) {
                ...
                fetch(`/api/additional-equipment/${id}`, {
                    ...
                    .then(equipment => {
                        ...
                        document.getElementById('detailDescription').textContent = equipment
                            .equipment_description;

                        // Vehicle info
                        if (equipment.vehicle) {
                            document.getElementById('detailVin').textContent = equipment.vehicle.vin;

                            // Get vehicle details
                            let manufacturerName = equipment.vehicle.manufacturer ? equipment.vehicle
                                .manufacturer.name : '-';
                            let modelName = equipment.vehicle.model ? equipment.vehicle.model.model_name :
                                '-';
                            let year = equipment.vehicle.first_registration ? new Date(equipment.vehicle
                            ...
                            if (manufacturerName === '-' || modelName === '-') {
                                ...
                                fetch(`/api/vehicles/${equipment.vehicle.vin}`, {
                                        headers: {
                                            'Accept': 'application/json',
                                            'X-Requested-With': 'XMLHttpRequest'
                                        }
                    ...
                    .catch(error => {
                        hideLoading();
                        showError('Error loading the equipment details: ' + error.message);
                        console.error('Error:', error);
                    });
            }
            ...
            function editEquipment(id) {
                ...
                fetch(`/api/additional-equipment/${id}`, {
                    ...
                    .then(equipment => {
                        ...
                        document.getElementById('equipment_description').value = equipment
                            .equipment_description;
