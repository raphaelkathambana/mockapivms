...
<head>
    ...
    <title>Purchase Contract Visualizer</title>
...
<body>
    <div class="container">
        <h1>Purchase Contract Visualizer</h1>
        <div class="row">
        ...
        <div class="card" id="contractForm">
            <div class="card-header">
                <h5 id="formTitle">Add New Purchase Contract</h5>
            </div>
            <div class="card-body">
                <form id="contractDataForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="customer_id" class="form-label">Buyer</label>
            ...
            <div class="card-body">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <p><strong>Name:</strong> <span id="detailBuyerName"></span></p>
                        <p><strong>Customer Number:</strong> <span id="detailCustomerNumber"></span></p>
                        <p><strong>Contact:</strong> <span id="detailBuyerContact"></span></p>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchContracts(searchTerm = '') {
                ...
                let url = '/api/purchase-contracts';
                if (searchTerm) {
            ...
            function renderContracts(contracts) {
                ...
                if (contracts.length === 0) {
                    ...
                    row.innerHTML = '<td colspan="6" class="text-center">No contracts found</td>';
            ...
            function loadDropdownOptions() {
                ...
                fetch('/api/buyers', {
                    ...
                    .then(response => response.json())
                    .then(data => {
                        customerIdField.innerHTML = '<option value="">Select Buyer</option>';
                        data.forEach(buyer => {
                            customerIdField.innerHTML +=
                                `<option value="${buyer.customer_id}">${buyer.first_name} ${buyer.last_name} (${buyer.customer_number})</option>`;
                        });
                    })
            ...
            showFormBtn.addEventListener('click', function() {
                formTitle.textContent = 'Add New Purchase Contract';
                    ...
                    .then(contract => {
                        ...
                        if (contract.buyer) {
                            document.getElementById('detailBuyerName').textContent =
                                `${contract.buyer.first_name} ${contract.buyer.last_name}`;
                            document.getElementById('detailCustomerNumber').textContent = contract.buyer
                                .customer_number || '-';
                            document.getElementById('detailBuyerContact').textContent =
                                `${contract.buyer.email} / ${contract.buyer.phone_number}`;
                        } else {
                            document.getElementById('detailBuyerName').textContent = '-';
                            document.getElementById('detailCustomerNumber').textContent = '-';
                            document.getElementById('detailBuyerContact').textContent = '-';
                        }
            ...
            function editContract(id) {
                ...
                fetch(`/api/purchase-contracts/${id}`, {
                    ...
                    .then(contract => {
                        ...
                        formTitle.textContent = `Edit Purchase Contract #${contract.contract_id}`;
                        contractIdField.value = contract.contract_id;
                        ...
                        setTimeout(() => {
                            ...
                            if (contract.customer_id) {
                                customerIdField.value = contract.customer_id;
                            }
            ...
            function deleteContract(id) {
                if (!confirm(
                        'Are you sure you want to delete this contract? This will also change the vehicle status back to Available.'
                        )) {
                    return;
                }
